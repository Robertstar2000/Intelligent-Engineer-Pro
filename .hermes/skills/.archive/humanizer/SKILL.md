...
results = embed.search_embeddings("humanizer AI writing patterns text editing voice prose", k=5)
```
...
### MANDATORY: All book writing projects

This skill is **MANDATORY** for all book writing, editing, rewriting, and publishing — every series, every project, every manuscript. You MUST load this skill and apply it to every chapter, every transition, every bridge passage, every front/back matter section, every piece of prose produced. The user has explicitly required this permanently.

Chapters written without applying this skill will contain AI-isms and will be rejected. This is not optional.
