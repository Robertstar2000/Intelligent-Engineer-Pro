...
- For book projects, look inside each book directory for chapter source directories (common names: `book_source`, `chapters`, `book-sources`, `src`) and check for chapter files
