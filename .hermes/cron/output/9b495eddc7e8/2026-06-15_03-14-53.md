...
This simple test only tries to import capture, tag, and score - which don't appear to have dependencies on sentence-transformers or faiss.

Let me run this to see if the basic components work.
