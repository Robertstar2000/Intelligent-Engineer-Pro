...
- Backup directory: `/mnt/usb_4tb/backups/hermes-20260607-012958`
- Archive created: `/mnt/usb_4tb/backups/hermes-20260607-012958.tar.gz`
- Size: 3.5 GB
- Old backups older than 30 days have been pruned (e.g., `hermes-20260507-010139.tar.gz` removed).

The backup includes all configured Hermes data (config, memories, skills, sessions, state database, books, etc.) excluding the hermes-agent repo and caches as specified. The USB drive at `/mnt/usb_4tb` was verified mounted before the operation.
