...
- **B-003**: Fresh start 2026-05-07. No emails sent yet. ⚠️ **Domain `thebookcellar.com` shows "FOR SALE" landing page.** Verify Marcus Webb's current affiliation before sending any outreach.
...
**All 8 consulting leads are blockers** — every lead has been in their current stage for 33 days, far exceeding the 7-day threshold. 4 leads have no email and cannot receive nurture until enriched.
...
**🔴 Critical: 100% of consulting leads are stale.** All 8 leads have been in their current stage for 33 days with no progression.
...
> ⚠️ Auto-advance rules are defined in `pipeline-saas.json` but are NOT executed by the orchestrator. These leads will remain at Stage 1 until manually advanced.
...
| S-002–S-005 | **Auto-advance + Day 1 nurture** | 4 leads, 32 days stale, ready for contact |

### Consulting
| Lead | Action | Notes |
|------|--------|-------|
| C-001 | Follow-up email | Contacted 2026-05-14, no progression in 33 days |
| C-003, C-006, C-007 | **Send nurture** | Have emails, verified entities |
| C-002, C-004, C-009, C-010 | ❌ Needs enrichment | No contact info |

**Summary:** 4 consulting leads ready for nurture, 4 need enrichment.
...
**Discrepancy:** Registry claims 10 consulting leads but only 8 exist. C-005 (Summit Nonprofit Alliance) and C-008 (Golden Gate Tech Incubator) were removed/de-marked as dead but the registry count was never updated. **Fix:** `total_leads: 10→8`, `total_leads_all: 18→16`.
