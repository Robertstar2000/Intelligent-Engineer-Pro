...
Report saved successfully. Here is the daily pipeline orchestrator output:

---

**📊 MIFECO Daily Pipeline Report — 2026-05-28**

**Registry Integrity:** ✅ PASS — 18 leads across 3 pipelines, all counts match.

**Pipeline Summary:**
- 📚 **Books:** 3 leads, 0 blockers, 2 stale in Stage 1 (20 days)
- ☁️ **SaaS:** 5 leads, 0 blockers, **4 auto-advance candidates** (all Stage 1, 20 days)
- 💼 **Consulting:** 10 leads, **🔴 ALL 10 are blockers** (>7 days stale)
- **Total pipeline value:** ~$2,242

**Key Findings:**
1. **4 SaaS leads need auto-advance** (S-002, S-003, S-004, S-005) — all at 20 days in Stage 1 (Identified), eligible for auto-advance to Stage 2 (Contacted)
2. **10 Consulting blockers** — 4 have emails but were never contacted; 6 need enrichment; 2 are DEAD leads (C-005 Summit Nonprofit Alliance, C-008 Golden Gate Tech Incubator)
3. **Books nurture sequence discrepancy** — missing 2 standalone titles ("The Owner's Manual for AI Agents", "Tomorrow Remembered"). All Books email sends are ⛔ ON HOLD until resolved.
4. **B-003 (Marcus Webb)** — domain thebookcellar.com shows FOR SALE landing page; verify before outreach
5. No new leads since last run; no leads advanced since 2026-05-14

**Full report saved to:** `pipeline-engine/data/daily-pipeline-report.md`
