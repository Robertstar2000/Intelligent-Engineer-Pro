...
All 7 steps complete. Report saved to `data/daily-pipeline-report.md`. Here's the summary:

---

## 📊 Daily Pipeline Report — 2026-06-05
...
### 🔴 Critical: 10 Consulting Blockers
All 10 consulting leads are stale (>7 days in current stage). C-001 (Northwind Health Partners) is at Stage 2 — contacted 29 days ago with no advancement. The other 9 remain at Stage 1 for 29 days.

**Action needed:** Review consulting pipeline — either advance active leads or mark dead/unverified ones as inactive.

### 🔄 SaaS: 4 Auto-Advances Due
S-002 (James Rodriguez), S-003 (Priya Sharma), S-004 (Michael Park), and S-005 (Elena Vasquez) have all been in Stage 1 (Identified) for 28 days ≥ 7-day threshold. All should advance to Stage 2 (Contacted) with Day 1 nurture emails triggered.

### 📚 Books: Stable
- **B-001** (Dr. Sarah Chen) — Stage 2, 21 days, awaiting reply
- **B-002** (Rev. Angela Torres) — Stage 1, needs initial outreach
- **B-003** (Marcus Webb) — Stage 1, ⚠️ domain verification required before proceeding

### 📧 Nurture Sequences: ✅ All Aligned
Books (5/5 titles), SaaS (3/3 products), Consulting (2/2 services) — no discrepancies.

### 🔐 Registry Integrity: ✅ PASS
Registry total: 18 | Actual: 18 (Books 3 + SaaS 5 + Consulting 10). Unified pipeline covers 10/18 leads (known subset behavior).

### 📬 Email Queue Summary
- **Books:** 1 awaiting reply (B-001), 2 need outreach (B-002, B-003 with domain flag)
- **SaaS:** 4 auto-advances due → Day 1 nurture emails
- **Consulting:** 4 ready for nurture (have emails), 6 need enrichment (no email)

### 📅 7-Day Projection
- SaaS: 4 leads advance to Stage 2, nurture sequences begin
- Books: B-002 initial outreach, B-003 domain verify
- Consulting: 4 leads ready for nurture, 6 need enrichment before any outreach
